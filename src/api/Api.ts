...
import { CENSUS_STATS_URL, DETAILS_HISTORY_URL, LOGO_URL, UNIT_ABBRS_URL } from '../constants/constants'
...
export default class Api {
	...
	static getUpdateTableData() {
		return axios.get( `${ DETAILS_HISTORY_URL }` )
	}
